...
const styles = StyleSheet.create({
  ...
  stockName: { fontSize: 18, fontWeight: "bold",fontFamily:"monospace",letterSpacing:-1.5 },
  stockExchange: { color: "#555",fontFamily:"monospace" },
  stockPrice: { fontSize: 16, fontWeight: "bold", marginTop: 5,fontFamily:"monospace" },
  stockChange: { fontSize: 16, fontWeight: "bold",fontFamily:"monospace" },
  positive: { color: "green" },
  negative: { color: "red" },
  rowContainer: { flexDirection: "row", justifyContent: "space-between" },
  flexItem: { flex: 1, marginRight: 10 },
  inputContainer: { marginBottom: 15 },
  label: { fontSize: 16, marginBottom: 5,fontFamily:"monospace" },
  inputBox: { borderWidth: 1, borderColor: "#ccc", borderRadius: 5, padding: 10,fontFamily:"monospace" },
  ...
  saveButton: { backgroundColor: "#007BFF", padding: 10, borderRadius: 5, flex: 1, alignItems: "center", marginLeft: 5,fontFamily:"monospace" },
